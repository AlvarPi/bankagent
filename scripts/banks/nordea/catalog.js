    ...
    items: [
      {
        ...
        summary:
          'Põhjamaade suurim pank. Ei paku Eesti erakliendi pangateenuseid — kogutud riiklikud näited (FI, SE).'
      },
      {
    ...
    items: [
      {
        ...
        summary: 'Paindlik säästukonto Soomes. Muutuv intress.',
        rates: ['Vaata nordea.fi JoustoTalletus lehte (kogutud parse)']
      },
      {
        name: 'Säästötilit',
      ...
      },
      {
        ...
        summary: 'Fikseeritud intressiga talletustodistus.'
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        rates: ['Vaata nordea.se sparkonton lehte (kogutud parse)']
      },
      {
        name: 'Fasträntekonto',
        url: 'https://www.nordea.se/privat/produkter/spara-investera/sparkonton/',
        summary: 'Fikseeritud intressiga hoius Rootsis.',
        rates: ['Intressivahemik: vaata nordea.se']
      },
      {
    ...
    items: [
      {
        ...
        summary: 'Asuntolaina, kulutusluotto jne.'
      },
      {
        name: 'Rootsi laenud',
        url: 'https://www.nordea.se/privat/produkter/lan/',
        summary: 'Bolån, privatlån jne.'
      },
      {
        name: 'Pangapaketid',
    ...
    items: [
      {
        ...
        details: ['Ei ole minuraha.ee baromeetris', 'Intressid riigiti erinevad']
      }
    ]
  }
];
